...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control"   }, "n", function () awful.spawn("emacsclient -e \"(call-interactively 'org-roam-capture)\" -c") end,
...
awful.rules.rules = {
    ...
    { rule_any = { class = { "spotify", "Spotify" }, instance = { "spotify", "Spotify" }, name = { "Spotify" },
    properties = { screen = 1, tag = "MUS" }} },
    { rule_any = { class = { "discord", "slack" },
    properties = { screen = 1, tag = "DSC" }} },
